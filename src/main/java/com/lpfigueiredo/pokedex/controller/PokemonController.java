package com.lpfigueiredo.pokedex.controller;

import com.lpfigueiredo.pokedex.model.Pokemon;
import com.lpfigueiredo.pokedex.model.PokemonEvent;
import com.lpfigueiredo.pokedex.repository.PokedexRepository;
...
public class PokemonController {
    ...
    public Mono<ResponseEntity<Void>> deletePokemon(@PathVariable(value = "id") String id) {
        return repository.findById(id).flatMap(existingPokemon -> repository.delete(existingPokemon)
